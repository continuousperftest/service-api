...
public class BarChartController {
  ...
  @Autowired
  private PerfomanceMetricDashboardService perfomanceMetricDashboardService;

  @CrossOrigin
  @RequestMapping(path = "/bar", method = RequestMethod.GET, produces = "application/json")
  public List<PerfMetricAggregation> getAllRequestsAverageTime(@RequestParam String startDate,
      @RequestParam String endDate, @RequestParam String groups, @RequestParam int threadCount) {
    return perfomanceMetricDashboardService.getMetricsGroupedByLaunchId(startDate, endDate, groups,
        threadCount);
  }
}
